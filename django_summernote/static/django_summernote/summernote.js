...
(function (factory) {
  ...
  var Editor = function () {
    ...
    * @param {jQuery} $target
    */
    this.editButton = function($editable, sValue, $target) {
        recordUndo($editable);

        $target.attr('id', 'aviary_image_editor_'+Math.random() * (9999 - 10) + 10);
...
//        console.log($btn);
      ...
      if ($btn.length) {
        ...
        var $target;
        if ($.inArray(sEvent, ['resize', 'floatMe', 'removeMedia', 'editButton']) !== -1) {
  ...
  var Renderer = function () {
    ...
    var tplPopovers = function (lang, options) {
      ...
      var tplImagePopover = function () {
        ...
        var editButton = tplIconButton('fa fa-pencil-square-o icon-pencil-square', {
        ...
        var content = '<div class="btn-group">' + fullButton + halfButton + quarterButton + '</div>' +
                      ...
                      '<div class="btn-group">' + editButton + '</div>' +
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body = '<div class="note-image-uploader"><h5>' + lang.image.selectFromFiles + '</h5>' +
                   '<input class="note-image-input" type="file" name="files" accept="image/*" /></div>' +
